      ...
      <div class="row gy-4 gx-4 gx-xl-5">
        ...
        <div class="col col-12 col-lg-8">
          ...
          <div class="d-flex flex-column gap-1 gap-lg-2">
            <?PHP
            //var_dump($detail) or die();
            
            echo "<p class='sidebar-title'><span class='glyphicon glyphicon-list'></span> Monografi&nbsp;</p>";
              echo "<a href='' title='Klik untuk detail'>
                ...
                <tbody>
                    ...
                    <tr>
                        <th> Tahun Terbit</th>
                        <td><?= date('Y', strtotime($detail->tgl_terbit)) ?></td>
                    </tr>
                     <tr>
                        <th>Lokasi</th>
                        <td><?= $detail->tempat_terbit; ?></td>
                    </tr>
                       <tr>
                        <th>Download</th>
                        <td></td>
