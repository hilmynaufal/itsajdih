      ...
      <div class="row gy-4 gx-4 gx-xl-5">
        ...
        <div class="col col-12 col-lg-8">
          ...
          <div class="d-flex flex-column gap-1 gap-lg-2">
            <?PHP echo "<p class='sidebar-title'><span class='glyphicon glyphicon-list'></span> Yurisprudensi&nbsp;</p>";
            ...
            foreach ($download->result_array() as $r) {
              ...
              echo "<a class='d-flex border rounded bg-white align-items-center link-dark lh-1 gap-1 gap-lg-2 gap-xl-3 p-2 p-lg-3' href='" . base_url() . "download/detail_download/$r[id_download]' title='Klik untuk detail'>
                    ...
                    <table  class='small text-secondary' >
                            <tbody class='small text-secondary'>
                             <tr>
                                    <td >Judul</td>
                                    <td >:<a href='" . base_url() . "download/detail_download/$r[id_download]'>$r[judul]</a></td>
                                </tr>
                                <tr>
                                    <td >T.E.U </td>
                                    <td >: $r[pengarang]</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class='btn btn-outline-success btn-sm' href='" . base_url() . "download/file/$r[nama_file]'><span class='glyphicon glyphicon-download-alt'></span> Download</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
