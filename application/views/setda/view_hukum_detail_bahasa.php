    ...
    <div class="container">
        <div class="row gy-5">
            <div class="col-lg-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <table class="table" width="100">
                            <tbody class='small text-secondary'>
                                <tr>
                                    ...
                                    <td><?php echo ucwords($detail->nama_dokumen); ?></td>
                                </tr>
                                <tr>
                                    <th width="30%" scope="row">Judul </th>
                                    <td><?php echo ucwords(strtolower($detail->jenis_nama . ' Nomor ' . $detail->no . ' Tahun ' . $detail->tahun . ' Tentang ' . $detail->nama)); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th width="30%" scope="row"> T.E.U. Badan / Pengarang </th>
                                    <td><?= ucwords($detail->pengarang); ?></td>
                                </tr>
                                ...
                                <tr>
                                    <th width="30%" scope="row">Jenis / Bentuk Peraturan </th>
                                    <td><?= $detail->jenis_nama; ?></td>
                                </tr>
                                <tr>
                                    <th width="30%" scope="row">Singkatan Jenis / Bentuk Peraturan </th>
                                ...
                                <tr>
                                    <th width="30%" scope="row">Status Peraturan </th>
                                    <td><?= $detail->status_peraturan; ?></td>
                                </tr>
                                <tr>
                                    <th width="30%" scope="row">Status </th>
                                    <td><?php
                                    if ($detail->visible == 1) {
                                        echo "Masih Berlaku";
                                    } else {
                                ...
                                <tr>
                                    <th width="30%" scope="row">Kode Lampiran </th>
                                    <td><?php echo ucwords(strtolower($detail->kode_lampiran)); ?> </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ucwords(strtolower($detail->yuris_jenis_peradilan)); ?> </td>
                                </tr>

                                <tr>
                                    <th width="30%" scope="row">Singkatan Jenis Peradilan</th>
                                    <td><?php echo ucwords(strtolower($detail->yuris_singakatanjenis_peradilan)); ?> </td>
                                </tr>


                                <tr>
                                    <th width="30%" scope="row">Tempat Peradilan </th>
                                    <td><?php echo ucwords(strtolower($detail->yuris_tempat_peradilan)); ?> </td>
                                </tr>


                                <tr>
                                    <th width="30%" scope="row">Tgl Dibacakan </th>
                                    <td><?php echo ucwords(strtolower($detail->yuris_tglbln_dibacakan)); ?> </td>
                                </tr>
                ...
                <div class="service-box">
                    ...
                    <div class="download-catalog">
                        <a href="<?PHP echo base_url() . 'hukum/download/' . $detail->id; ?>"><i
                                class="bi bi-filetype-pdf"></i><span>Download</span></a>
            ...
            <div class="col-lg-8 ps-lg-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                ...
                $file_download = $detail->path_file_inggris;
