...
//                      </div> ";
                ...
                echo "<div class='item $aktif'><div class='single-slide' style='padding: 30px 20px;'>
					<a href='#'><div class='col-md-3'><img style='width:350px; height:200px' class='img-thumbnail' src='".base_url()."asset/foto_berita/".$foto."' class='img-responsive'></div></a>
					 <div class='col-md-9'>
                                      <h3><a href='".base_url()."berita/detail/$row[judul_seo]'>$row[judul]</a></h3>
                                      <p>$isi... <a href='".base_url()."berita/detail/$row[judul_seo]'><span class='btn btn-success btn-xs'><small>Baca Selanjutnya</small></span></a></p>
                                  </div>
				</div>
                                </div> ";
