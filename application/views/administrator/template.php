...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <link href='<?php echo base_url(); ?>asset/admin/datatable/css/buttons.dataTables.min.css' rel='stylesheet' type='text/css'>
    <link href='<?php echo base_url(); ?>asset/admin/datatable/css/dataTables.bootstrap.min.css' rel='stylesheet' type='text/css'>
    <link href='<?php echo base_url(); ?>asset/admin/datatable/css/buttons.bootstrap.min.css' rel='stylesheet' type='text/css'> 

    <script src="<?php echo base_url(); ?>asset/admin/datatable/js/dataTables.buttons.min.js"></script>
    <script src=<?php echo base_url(); ?>asset/admin/datatable/js/buttons.bootstrap.min.js"></script> 
    <script src="<?php echo base_url(); ?>asset/admin/datatable/js/buttons.html5.min.js"></script> 
    <script src="<?php echo base_url(); ?>asset/admin/datatable/js/buttons.print.min.js"></script>

    <script src="<?php echo base_url(); ?>asset/admin/datatable/js/buttons.colVis.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/admin/datatable/js/jszip.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/admin/datatable/js/pdfmake.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/admin/datatable/js/vfs_fonts.js"></script>
