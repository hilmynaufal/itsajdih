            <div class="col-xs-12">  
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table tabzle-bordered table-striped">
                    <thead>
                      <tr>
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$tgl</td>
                              <td><center>
                               aa <a class='btn btn-success btn-xs' title='Edit Data' href='".base_url()."administrator/detail_pesanmasuk/$row[id_hubungi]'><span class='glyphicon glyphicon-send'></span></a>
