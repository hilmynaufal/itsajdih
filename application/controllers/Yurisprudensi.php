...
class Yurisprudensi extends CI_Controller {
	public function index(){
		$data['title'] = 'Halaman Yurisprudensi';
		$jumlah= $this->model_utama->hitungdownload()->num_rows();
		$config['base_url'] = base_url().'yurisprudensi/index';
		...
		$this->template->load(template().'/template',template().'/view_yurisprudensi',$data);
	}
