...
// Controller Modul Pegawai
        ...
        public function ajax_list()
	{
		...
		foreach ($list as $data_hukum) {
			...
			$row = array();
                        $row[] = $no;
			$row[] = '<a data-toggle="modal" data-target="#myModal'.$data_hukum->id.'"><span class="glyphicon glyphicon-zoom-in"></span></a>';
                                    ...
                                    <div class="modal-dialog">
                                     <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <dt>Abstak : </dt>
                                            <dd> '.$data_hukum->abstrak.' </dd>
                                            <dt>Katalog</dt>
                                            <dd> '.$data_hukum->katalog.' </dd>
                                            <dd> <a class="btn-primary btn  btn-xs" target="_blank" href="'.base_url($path['file_path']).' ">Ada : <span class="glyphicon glyphicon-open"></span> Dokument '.($no_path-1).' </a></dd>
			...
			$row[] = $data_hukum->tanggal_diundangkan;
